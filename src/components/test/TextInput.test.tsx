...
describe('TextInput Component', () => {
  ...
  it('displays the correct initial value', () => {
    ...
    render(<TextInput value="ACTG" onChange={() => {}} name='' placeholder='' />);
  ...
  it('renders the TextInput component', () => {
    ...
    render(<TextInput value='' onChange={() => {}} name='label text' placeholder='' />);
  ...
  it('calls onChange when text is entered', () => {
    ...
    render(<TextInput value='' onChange={handleChange} name='' placeholder='' />);
    const inputElement = screen.getByRole('textbox');
